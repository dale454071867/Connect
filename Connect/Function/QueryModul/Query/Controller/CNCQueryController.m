...
@interface CNCQueryController ()<QMUITableViewDelegate, QMUITableViewDataSource>
...
- (void)setupNavigationItems {
    ...
    if (CNCSQL.accountModels.count) {
        self.navigationItem.rightBarButtonItem = [UIBarButtonItem qmui_itemWithTitle:@"编辑" target:self action:@selector(rightBarButtonItemDidClick)];
    }
}
